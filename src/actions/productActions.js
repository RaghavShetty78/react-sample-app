...
export const getProductsList = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      "http://35.172.194.119:32769/api/products/"
    );
...
export const getProductDetails = (id) => async (dispatch) => {
  try {
    ...
    // call api
    const { data } = await axios.get(
      `http://35.172.194.119:32769/api/product/${id}/`
    );
...
export const createProduct = (product) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post(
      "http://35.172.194.119:32769/api/product-create/",
      product,
      config
    );
...
export const deleteProduct = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.delete(
      `http://35.172.194.119:32769/api/product-delete/${id}/`,
      config
    );
...
export const updateProduct = (id, product) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `http://35.172.194.119:32769/api/product-update/${id}/`,
      product,
      config
    );
...
export const changeDeliveryStatus =
  (id, product) => async (dispatch, getState) => {
    try {
      ...
      // api call
      const { data } = await axios.put(
        `http://35.172.194.119:32769/account/change-order-status/${id}/`,
        product,
        config
      );
