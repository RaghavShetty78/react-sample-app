...
export const createCard = (cardData) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post(
      "http://35.172.194.119:32769/payments/create-card/",
      {
...
export const chargeCustomer = (cardData) => async (dispatch, getState) => {
  try {
    ...
    // api call
    const { data } = await axios.post(
      "http://35.172.194.119:32769/payments/charge-customer/",
      cardData,
      config
    );
...
export const savedCardsList = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(
      "http://35.172.194.119:32769/account/stripe-cards/",
      config
    );
...
export const updateStripeCard = (cardData) => async (dispatch, getState) => {
  try {
    ...
    // api call
    const { data } = await axios.post(
      "http://35.172.194.119:32769/payments/update-card/",
      cardData,
      config
    );
...
export const deleteSavedCard = (card_number) => async (dispatch, getState) => {
  try {
    ...
    // api call
    const { data } = await axios.post(
      "http://35.172.194.119:32769/payments/delete-card/",
