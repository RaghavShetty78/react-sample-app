...
export const login = (username, password) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      "http://35.172.194.119:32769/account/login/",
...
export const register = (username, email, password) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `http://35.172.194.119:32769/account/register/`,
...
export const checkTokenValidation = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(
      "http://35.172.194.119:32769/payments/check-token/",
      config
    );
...
export const userDetails = (id) => async (dispatch, getState) => {
  try {
    ...
    // call api
    const { data } = await axios.get(
      `http://35.172.194.119:32769/account/user/${id}`,
      config
    );
...
export const userUpdateDetails = (userData) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `http://35.172.194.119:32769/account/user_update/${userInfo.id}/`,
      {
...
export const userAccountDelete = (userData) => async (dispatch, getState) => {
  try {
    ...
    // call api
    const { data } = await axios.post(
      `http://35.172.194.119:32769/account/user_delete/${userData.id}/`,
      {
        password: userData.password,
      },
      config
...
export const getAllAddress = () => async (dispatch, getState) => {
  try {
    ...
    // call api
    const { data } = await axios.get(
      "http://35.172.194.119:32769/account/all-address-details/",
      config
    );
...
export const getSingleAddress = (id) => async (dispatch, getState) => {
  try {
    ...
    // call api
    const { data } = await axios.get(
      `http://35.172.194.119:32769/account/address-details/${id}/`,
      config
    );
...
export const createUserAddress =
  (addressData) => async (dispatch, getState) => {
    try {
      ...
      // call api
      const { data } = await axios.post(
        "http://35.172.194.119:32769/account/create-address/",
        addressData,
        config
      );
...
export const updateUserAddress =
  (id, addressData) => async (dispatch, getState) => {
    try {
      ...
      // call api
      const { data } = await axios.put(
        `http://35.172.194.119:32769/account/update-address/${id}/`,
        addressData,
        config
      );
...
export const deleteUserAddress = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.delete(
      `http://35.172.194.119:32769/account/delete-address/${id}/`,
      config
    );
...
export const getAllOrders = () => async (dispatch, getState) => {
  try {
    ...
    // call api
    const { data } = await axios.get(
      `http://35.172.194.119:32769/account/all-orders-list/`,
      config
    );
